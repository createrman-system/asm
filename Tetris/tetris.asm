...
delay_loop4:
    ...
    jnz delay_loop3
    ret
get_keyboard_char endp 
is_this_my_block proc
  ret   
is_this_my_block endp
collapse proc
...
is_this_block_free_exit_simple: 
    ...
    inc block_finish_row     
   ret
is_this_block_free_simple endp
...
init_clear_screen proc
    ...
    mov dx, 184Fh   
    ret       
init_clear_screen endp  
init_graphic_mode proc 
    mov ah, 00h
    mov al, 13h
    int 10h         
    ret   
init_graphic_mode endp
...
genrate_random_number_init proc
   ...
   ret
genrate_random_number_init endp
